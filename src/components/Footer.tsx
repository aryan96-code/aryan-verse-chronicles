...
const Footer = () => {
  const socialLinks = [
    {
      name: "Instagram",
      url: "https://instagram.com/aryanwrites", // Replace with actual Instagram handle
      icon: (
    ...
    {
      name: "Twitter",
      url: "https://twitter.com/aryanwrites", // Replace with actual Twitter handle
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "Facebook",
      url: "https://facebook.com/aryanwrites", // Replace with actual Facebook page
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center mb-4">
            <Feather className="w-8 h-8 text-gold mr-3" />
            <span className="text-3xl font-dancing font-bold">Aryan Writes</span>
          </div>
        ...
        <div className="border-t border-white/20 pt-8 text-center">
          ...
          <div className="flex items-center justify-center text-gold font-dancing text-xl">
