...
const Footer = () => {
  const socialLinks = [
    {
      name: "Instagram",
      url: "https://www.instagram.com/aryanwrites.18?igsh=dXdwbG8yMjI2cXZj", // Replace with actual Instagram handle
      icon: (
    ...
    {
      name: "Twitter",
      url: "", // Replace with actual Twitter handle
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "Facebook",
      url: "", // Replace with actual Facebook page
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
